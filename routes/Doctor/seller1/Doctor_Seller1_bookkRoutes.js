...
import Room from '../../../models/Doctor/seller1/Doctor_Seller1_Book.js';
import { v4 as uuidv4 } from 'uuid';

const router = express.Router();

// Add new room
router.post('/Doctor_Seller1_Book', async (req, res) => {
...
// Get all rooms
router.get('/Doctor_Seller1_Book', async (req, res) => {
  try {
...
// Delete a room
router.delete('/Doctor_Seller1_Book/:id', async (req, res) => {
  try {
...
// Book a room
router.put('/Doctor_Seller1_Book/:id/book', async (req, res) => {
...
router.get('/Doctor_Seller1_Book/:id/bookings', async (req, res) => {
  try {
...
router.get('/Doctor_Seller1_Book/booked', async (req, res) => {
...
router.put('/Doctor_Seller1_Book/:roomId/bookings/:bookingId', async (req, res) => {
...
router.post('/Doctor_Seller1_Book/:id/comment', async (req, res) => {
  const { text } = req.body;
...
// routes/rooms.js
router.put('/Doctor_Seller1_Book/:id/like', async (req, res) => {
  try {
    const room = await Room.findByIdAndUpdate(
      req.params.id,
      { $inc: { likes: 1 } },
